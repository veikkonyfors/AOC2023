...
class Day18Test {
    ...
    @Test
    fun solvePuzz1(){
        var day18 = Day18("src/main/resources/raw/input_test")
        var i = day18.solvePuzz1()
        println("$i")
        assertEquals(62,i)

        day18 = Day18("src/main/resources/raw/input")
        i = day18.solvePuzz1()
        println("$i")
    ...
    fun day18Puzz2() {
        ...
        day18 = Day18("src/main/resources/raw/input_test")
    ...
    fun day18Puzz1(){
        ...
        day18 = Day18("src/main/resources/raw/input_test") // For input 381 x 234
